...
## Настройка матча
Перед стартом (и в каждой фазе закупки) выбираются:
...
Узнаваемая планировка: B-site, CT spawn, A-site с дефолт-плитой, mid + mid doors, catwalk/short, long A с дверями и pit, туннели с изгибом, T-spawn. Масштаб выверен под игрока (узкие кишки, длинные линии для AWP). **Радар как в CS**: тёмный квадрат с центром на игроке, светлые проходы, буквы плентов A/B, точки команды и врагов, маркер бомбы. A* навигация ботов.
