...
- **R8 Револьвер** ($600) в пистолетах: **задержка перед выстрелом** (0.4с — крутит барабан, как в CS), бьёт 74 в тело / хедшот-машина, высокое пробитие; **у R8 нет double tap**. Есть у ботов и в килфиде
