...
- **Experimental (only-you)** — экспериментальные фичи только для игрока: **Rapid fire** (×4 темп — и полуавтоматы стреляют при удержании), **No spread** (нулевой разброс), **Fake peek** (держать H — выносит фейк-модель вперёд как приманку), **Defensive lag** (форс-чок и широкий десинк при отжатии double tap)
